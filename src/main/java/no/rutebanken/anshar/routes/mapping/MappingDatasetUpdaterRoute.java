...
public class MappingDatasetUpdaterRoute extends BaseRouteBuilder {
    ...
    public void configure() {
        ...
        if (quayMappingUrl != null && !quayMappingUrl.isEmpty() &&
            ...
            singletonFrom("quartz2://anshar.import.mapping.quay?fireNow=true&trigger.repeatInterval=" + frequencyMinutes * 60000
        ...
        if (stopPlaceMappingUrl != null && !stopPlaceMappingUrl.isEmpty() &&
            ...
            singletonFrom("quartz2://anshar.import.mapping.stop_place?fireNow=true&trigger.repeatInterval=" + frequencyMinutes * 60000
        ...
        if (jbvCodeStopPlaceMappingUrl != null && !jbvCodeStopPlaceMappingUrl.isEmpty() &&
            ...
            singletonFrom("quartz2://anshar.import.mapping.jbv_code?fireNow=true&trigger.repeatInterval=" + frequencyMinutes * 60000
