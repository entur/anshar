...
@Mapping(id="banenoret-flt-vy")
public class BaneNorEtFltVyValueAdapters extends MappingAdapter {
    ...
    public List<ValueAdapter> getValueAdapters(SubscriptionSetup subscriptionSetup) {
        ...
        operatorOverrideMapping.put("SJ", "SJN");
        operatorOverrideMapping.put("GAG", "GOA");

        List<String> operatorsToIgnore = Arrays.asList(
                "FLY",
                "VY",
                "VYG",
                "VYT");
