...
public class Siri20ToSiriWS14Subscription extends SiriSubscriptionRouteBuilder {
    ...
    public Siri20ToSiriWS14Subscription(CamelConfiguration config, SiriHandler handler, SubscriptionSetup subscriptionSetup, SubscriptionManager subscriptionManager) {
