...
public class EnsureIncreasingTimesForCancelledStopsProcessorTest extends SpringBootBaseTest {

    private EnsureIncreasingTimesForCancelledStopsProcessor processor = new EnsureIncreasingTimesForCancelledStopsProcessor("TST");
    ...
    public void testNonIncreasingTimesData() throws JAXBException {
        ...
        secondCall.setCancellation(Boolean.TRUE);
    ...
    public void testNoExpectedTimesData() throws JAXBException {
        ...
        secondRecordedCall.setCancellation(Boolean.TRUE);
